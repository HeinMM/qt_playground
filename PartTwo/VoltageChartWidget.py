...
class VoltageChartWidget(QWidget):
    ...
    def plot_voltage_chart(self):
        ...
        voltages = [self.ca, self.bc, self.ab]
        labels = ["C-A", "B-C", "A-B"]
        ...
        self.ax.set_title("VOLTAGE", color=GlobalColor.TEXT_COLOR, fontsize=8, pad=13)
        ...
        self.ax.set_xticks([342, 418])
        self.ax.set_xticklabels(["342", "418"], color="yellow")
        ...
        target_min, target_max = 342, 418
        self.ax.axvline(target_min, color=GlobalColor.RED, linestyle="--")
        self.ax.axvline(target_max, color=GlobalColor.RED, linestyle="--")
